...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <!-- About Section -->
  <div class="w3-container w3-padding-32" id="p4">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Website construction</h3>
  </div>

  <div class="w3-container w3-padding-32">
    <img class="w3-image" src="/img/project4.jpeg" style="width:100%">
  </div>

  <div class="w3-container w3-padding-32">
    <p>We offer a full range of custom web design services to increase your website traffic and leads. Our highly skilled,
      professional website designers, website developers and online marketing team will help you succeed online!</br></p>
  </div>
