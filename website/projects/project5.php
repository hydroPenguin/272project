...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <!-- About Section -->
  <div class="w3-container w3-padding-32" id="p5">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Cloud storage</h3>
  </div>

  <div class="w3-container w3-padding-32">
    <img class="w3-image" src="/img/project5.jpeg" style="width:100%">
  </div>

  <div class="w3-container w3-padding-32">
    <p>Designed to take teamwork to the next level. We helps your company grow without limits, while you maintain
       complete control over important company information and user activity.</br></p>
  </div>
